...
public interface INotificationService
{
    ...
    Task SendToRolesAsync(IEnumerable<string> roles, string title, string message, string type, string eventType, string? referenceType = null, int? referenceId = null, string? actionUrl = null, string? eventId = null, CancellationToken cancellationToken = default);
}
