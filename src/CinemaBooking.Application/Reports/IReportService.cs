...
public interface IReportService
{
    ...
    Task<TopSellingReport> TopSellingAsync(DateTime fromUtc, DateTime toUtc, int? cinemaId, int actorId, string? ip, CancellationToken ct);
    Task<object> RevenueAsync(DateTime fromUtc, DateTime toUtc, string groupBy, int? cinemaId, int actorId, string? ip, CancellationToken ct);
