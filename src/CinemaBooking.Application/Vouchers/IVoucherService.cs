...
public interface IVoucherService
{
    ...
    Task<VoucherResult> CreateAsync(int adminId, VoucherCommand command, string? ip, CancellationToken cancellationToken);
    Task<VoucherResult> UpdateAsync(int adminId, int id, VoucherCommand command, string? ip, CancellationToken cancellationToken);
