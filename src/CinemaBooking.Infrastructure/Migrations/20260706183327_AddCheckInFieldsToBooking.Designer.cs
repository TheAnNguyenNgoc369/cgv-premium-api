...
namespace CinemaBooking.Infrastructure.Migrations
{
    ...
    [Migration("20260706183327_AddCheckInFieldsToBooking")]
    partial class AddCheckInFieldsToBooking
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CinemaBooking.Domain.Entities.Booking", b =>
                {
                    ...
                    b.HasIndex("CheckedInByUserId")
                        .HasDatabaseName("IX_Booking_CheckedInByUserId");
            ...
            modelBuilder.Entity("CinemaBooking.Domain.Entities.LoyaltyPoints", b =>
                {
                    ...
                    b.ToTable("LoyaltyPoints", null, t =>
                        {
                            t.HasCheckConstraint("CK_LoyaltyPoints_TransactionType", "[TransactionType] IN ('earn', 'redeem', 'expire', 'adjust')");
                        });
                });
            ...
            modelBuilder.Entity("CinemaBooking.Domain.Entities.Booking", b =>
                {
                    b.HasOne("CinemaBooking.Domain.Entities.User", "CheckedInByUser")
                        .WithMany()
